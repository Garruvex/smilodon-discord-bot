...
| 4. Creation, house rules, and art | Guided builder, house-rule option cards, scene images with budgets | Selected options change actual mechanics; image failures leave text play working |

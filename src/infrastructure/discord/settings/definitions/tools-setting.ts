...
function handleToolToggle(
  ...
  const name = request.values.getString("name", true);
...
export const toolsEnableSetting: MutationSettingDefinition = {
  ...
  handle: (request, deps, previousProfile, input) =>
    Promise.resolve(handleToolToggle("enable", request, deps, previousProfile, input)),
...
export const toolsDisableSetting: MutationSettingDefinition = {
  ...
  handle: (request, deps, previousProfile, input) =>
    Promise.resolve(handleToolToggle("disable", request, deps, previousProfile, input)),
  describe: (previous, updated) => describeDisabledTools(previous, updated),
};

...
export async function buildProgressBarSettings(
  ...
  const style = request.values.getString("progress-style") as ProgressBarStyle | null;
  const length = request.values.getInteger("progress-length");
  const values = {
    completed: request.values.getString("progress-completed"),
    remaining: request.values.getString("progress-remaining"),
    playing: request.values.getString("progress-playing"),
    paused: request.values.getString("progress-paused"),
    ending: request.values.getString("progress-ending"),
  };

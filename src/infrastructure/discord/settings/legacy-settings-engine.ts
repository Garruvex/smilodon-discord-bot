...
export interface LegacySettingsEngineOptions {
...
// Runs the settings groups that haven't moved to the settings registry yet
// (see ./engine/settings-engine.ts). Deleted once every group has.
export class LegacySettingsEngine {
  private readonly deps: SettingDeps;

  public constructor(
    private readonly options: LegacySettingsEngineOptions,

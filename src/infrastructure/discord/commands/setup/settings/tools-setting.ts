...
function configureToolNameOption(b: SlashCommandSubcommandBuilder, description: string): SlashCommandSubcommandBuilder {
  return b.addStringOption((o) => o.setName("name").setDescription(description).setRequired(true));
}
...
export const toolsEnableSetting: MutationSettingDefinition = {
  ...
  configureOptions: (b) => configureToolNameOption(b, "Tool name to enable."),
...
export const toolsDisableSetting: MutationSettingDefinition = {
  ...
  configureOptions: (b) => configureToolNameOption(b, "Tool name to disable."),
  handle: (context, deps, previousProfile, input) =>

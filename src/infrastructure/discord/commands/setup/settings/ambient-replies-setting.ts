...
export const ambientRepliesSetting: MutationSettingDefinition = {
  ...
  configureOptions: (b) => b
    ...
    .addIntegerOption((o) => o.setName("cooldown-seconds").setDescription("Minimum seconds between ambient judgment calls per channel.").setMinValue(0).setMaxValue(86_400)),

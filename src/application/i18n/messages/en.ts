...
export const en = {
  ...
  // /status: how the bot is set up in this server.
  "setup.status.guildOnly": "Status is only available in a server.",
  "setup.status.title": "Server status",
  "setup.status.notConfigured": "This server isn't set up yet. Run `/setup initialize` to get started.",
  "setup.status.permissions": "Permissions",
  "setup.status.permissionsOk": "✅ I have every permission I need.",
  "setup.status.permissionsMissing": "⚠️ I'm missing: {permissions}",
  "setup.status.configured": "✅ This server is set up.",
  "setup.status.controlChannel": "Control channel: {channel}",
  "setup.status.adminPanel": "Admin panel: {channel}",
  "setup.status.adminPanelNone": "Admin panel: none — set one with `/settings-access admin-panel`",
  "setup.status.profileFile": "Profile file: `{file}`",
  "setup.status.none": "none",
  "setup.status.unknown": "unknown",
  "setup.status.panelIssue.missingPermissions": "⚠️ Admin panel: I'm missing {permissions} in {channel}.",
  "setup.status.panelIssue.cannotLock": "⚠️ Admin panel: I can't stop members posting in {channel} (needs Manage Permissions).",
  "setup.status.panelIssue.healingPaused": "⚠️ Admin panel: its messages keep getting deleted, so I stopped reposting them. Run `/settings-access repair-panel`.",
  "setup.status.panelIssue.channelDeleted": "⚠️ Admin panel: its channel was deleted. Pick a new one with `/settings-access admin-panel`.",
  "setup.status.features": "Features",
  "setup.status.feature.common": "General commands",
  "setup.status.feature.diagnostics": "Diagnostics",
  "setup.status.feature.music": "Music",
  ...
  "setup.status.role.botAdministrator": "Bot admins",
  "setup.status.role.musicController": "Music controllers",
  "setup.status.role.chatbot": "AI chat",
  "setup.status.role.restricted": "Restricted",
  "setup.status.role.none": "none configured",
  "setup.status.models": "Chat model",
  "setup.status.model.none": "No chat model configured — AI chat is unavailable.",
  "setup.status.model.replies": "Replies",
  "setup.status.model.background": "Background tasks",
  "setup.status.model.memorySearch": "Memory search",
  "setup.status.model.fallbacks": "Fallbacks: {models}",
  "setup.status.on": "On",
  "setup.status.off": "Off",
  "setup.status.auto": "Auto",
  "setup.status.chat.title": "AI chat settings",
  "setup.status.chat.cooldowns": "Reply cooldown: {reply}s · Name-mention cooldown: {ambient}s",
  "setup.status.chat.tools": "Web search: {webSearch} · Tools: {tools}",
  "setup.status.chat.toolsWithDisabled": "Web search: {webSearch} · Tools: {tools} ({count} disabled)",
  "setup.status.chat.images": "Reads images: {read} · Makes images: {make}",
  "setup.status.chat.sources": "Cites sources: {sources} · Persona drift: {drift}",
  "setup.status.chat.history": "Reads last {count} messages for context",
  "setup.status.chat.summaries": "Summarized channels: {once} one-time, {daily} daily",
  "setup.status.music.title": "Music settings",
  "setup.status.music.volume": "Volume: {volume}% by default (max {max}%, buttons ±{step})",
  "setup.status.music.queueEnd": "When the queue ends: {action}",
  "setup.status.music.everyoneLeaves": "When everyone leaves: {action}",
  "setup.status.music.stay": "stay connected",
  "setup.status.music.keepPlaying": "keep playing",
  "setup.status.music.leaveAfter": "leave after {duration}",
  "setup.status.music.pauseAfter": "pause after {duration}",
  "setup.status.music.resume": "Resume when someone returns: {value}",
  "setup.status.music.progressBar": "Progress bar: {style}, {length} wide",
  "setup.status.duration.now": "immediately",
  "setup.status.duration.seconds": "{seconds}s",

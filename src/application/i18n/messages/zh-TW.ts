...
export const zhTW = {
  ...
  "music.panel.queue.more": "…還有 {count} 首，其餘曲目請用 `/queue show` 查看",
  ...
  "music.reply.autoqueueEnabled": "已開啟自動佇列。",
  "music.reply.autoqueueDisabled": "已關閉自動佇列。",
  ...
  "music.reply.moved": "已將 **{title}** 移至佇列第 **{position}** 位。",
  ...
  "music.reply.shuffled": "已隨機排列佇列中的曲目。",
  "music.reply.replaying": "正在重新播放 **{title}** — {author}。",
  "music.reply.removed": "已從佇列移除 **{title}**。",
  "music.reply.clearedOne": "已清除佇列中的 {count} 首曲目。",
  "music.reply.clearedMany": "已清除佇列中的 {count} 首曲目。",
  ...
  "music.card.positionInQueue": "佇列位置",
